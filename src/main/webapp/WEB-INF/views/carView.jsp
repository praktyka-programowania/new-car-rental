...
<div class="row">
    <div class="col-md-4">
        <img src="/resources/cars/${car.id}.png" onerror="this.src='/resources/cars/default.png'" alt="Car: ${car.id}" width="350" height="250"/>
    </div>
    <div class="col-md-8">
        <ul style="list-style-type: none;">
            <li> <h2 style="margin-top: 5px;">${car.company}</h2> </li>
            <li> <h3>${car.model}</h3> </li>
            <li> <h3>${car.year}</h3> </li>
            <li><h4>&#36;${car.price} / per mounth (30 days)</h4></li>
            <br>
